---
title: "UniprotR documentation"
author: "Mohamed Soudy, Ali Mostafa Anwar, Eman Ali Ahmed, Aya Osama, Shahd Ezzeldin, Sebaey Mahgoub and Sameh Magdeldin"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{UniprotR documentation}
  %\VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---
#UniprotR is used for retrieving information of proteins from Uniprot

**Import your data from CSV or txt file**
...
```
**Get Names and taxonomy information**
